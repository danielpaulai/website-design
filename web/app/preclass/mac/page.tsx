...
export const metadata: Metadata = {
  title: "Pre-Class Setup — macOS",
  description: "Step-by-step setup for Mac users before the Aura Build workshop.",
};

export default function MacGuide() {
  const docPath = path.join(process.cwd(), "..", "workshop", "MAC-GUIDE.md");
